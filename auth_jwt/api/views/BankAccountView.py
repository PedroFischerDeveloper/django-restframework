...
class BankAccountView(APIView):  
    ...
    def post(self, request):   
        created_bank_account = BankAccountService.create(data=request.data)
    ...
    def get(self, request, id):
        usuario_existe = BankAccountService.get(id)
        if usuario_existe:
    ...
    def get(self, request):
        ...
        paginated_usuarios = BankAccountService.list_paged(page, page_size)
